...
import { Component, Input, ContentChild, NgModule, EventEmitter, Output, Directive, InjectionToken, Injectable, Inject, ViewChild, ContentChildren } from '@angular/core';
...
class OverlayComponent {
    ...
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "17.2.0", type: OverlayComponent, selector: "app-overlay", inputs: { dismissable: "dismissable", style: "style" }, outputs: { onShow: "onShow", onHide: "onHide" }, ngImport: i0, template: "<ng-template \r\n    cdkConnectedOverlay\r\n    [cdkConnectedOverlayOrigin]=\"target\"\r\n    [cdkConnectedOverlayOpen]=\"isOpen\" \r\n    [cdkConnectedOverlayHasBackdrop]=\"dismissable\"\r\n    cdkConnectedOverlayBackdropClass=\"cdk-overlay-transparent-backdrop\" \r\n    (backdropClick)=\"hide()\">\r\n\r\n    <div class=\"overlay\" [ngStyle]=\"style\">\r\n        <ng-content></ng-content>\r\n    </div>  \r\n</ng-template>", styles: [".overlay{background:#fff;padding:1rem;border-radius:5px;box-shadow:0 2px 4px -1px #0003,0 4px 5px #00000024,0 1px 10px #0000001f}\n"], dependencies: [{ kind: "directive", type: i1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }, { kind: "directive", type: i2$2.CdkConnectedOverlay, selector: "[cdk-connected-overlay], [connected-overlay], [cdkConnectedOverlay]", inputs: ["cdkConnectedOverlayOrigin", "cdkConnectedOverlayPositions", "cdkConnectedOverlayPositionStrategy", "cdkConnectedOverlayOffsetX", "cdkConnectedOverlayOffsetY", "cdkConnectedOverlayWidth", "cdkConnectedOverlayHeight", "cdkConnectedOverlayMinWidth", "cdkConnectedOverlayMinHeight", "cdkConnectedOverlayBackdropClass", "cdkConnectedOverlayPanelClass", "cdkConnectedOverlayViewportMargin", "cdkConnectedOverlayScrollStrategy", "cdkConnectedOverlayOpen", "cdkConnectedOverlayDisableClose", "cdkConnectedOverlayTransformOriginOn", "cdkConnectedOverlayHasBackdrop", "cdkConnectedOverlayLockPosition", "cdkConnectedOverlayFlexibleDimensions", "cdkConnectedOverlayGrowAfterOpen", "cdkConnectedOverlayPush", "cdkConnectedOverlayDisposeOnNavigation"], outputs: ["backdropClick", "positionChange", "attach", "detach", "overlayKeydown", "overlayOutsideClick"], exportAs: ["cdkConnectedOverlay"] }] }); }
}
...
(function (DataType) {
    ...
    DataType[DataType["Amount"] = 2] = "Amount";
    DataType[DataType["Image"] = 3] = "Image";
    DataType[DataType["File"] = 4] = "File";
    DataType[DataType["Bool"] = 5] = "Bool";
    DataType[DataType["Color"] = 6] = "Color";
    DataType[DataType["DateTime"] = 7] = "DateTime";
    DataType[DataType["Check"] = 8] = "Check";
    DataType[DataType["Users"] = 9] = "Users";
})(DataType || (DataType = {}));
...
class TableColumnDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.2.0", ngImport: i0, type: TableColumnDirective, deps: [{ token: i0.TemplateRef }], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "17.2.0", type: TableColumnDirective, selector: "[table-column]", inputs: { id: ["table-column", "id"] }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.0", ngImport: i0, type: TableColumnDirective, decorators: [{
            type: Directive,
            args: [{
...
class TableModule {
    ...
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.2.0", ngImport: i0, type: TableModule, declarations: [TableComponent], imports: [
            ...
            FilterModule,
            ActionModule,
            TableModule$1], exports: [TableComponent] }); }
...
export { ActionComponent, ActionModule, EDITOR, EditorComponent, EditorModule, EditorService, FilterComponent, FilterModule, OverlayComponent, OverlayModule, PickerComponent, PickerEditorComponent, PickerModule, SortPanelComponent, SortPanelModule, TableComponent, TableModule };
